...
func TestIsDevVersion(t *testing.T) {
	tests := []struct {
		...
		{version: "  dev  ", want: true},
		{version: "v0.0.0-20260424223654-88d1dd693833", want: true},
		{version: "v0.0.0-20260424223654-88d1dd693833+dirty", want: true},
		{version: "0.0.0-20260424223654-88d1dd693833", want: true},
		{version: "v1.2.3+dirty", want: true},
		{version: "v1.2.3", want: false},
		{version: "1.2.3", want: false},
		{version: "v1.2.3-rc1", want: false},
		{version: "v1.2.3+abc", want: false},
	}
	for _, tt := range tests {
